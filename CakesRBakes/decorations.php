...
<body class="sub_page">
  ...
  <!-- <div class="main_body_content"> -->
    ...
    <div class="heading_container">
        ...
        <p class="offset-lg-3">
        Enhance Every Celebration with Our Premium Cake Decoration Items. Create Stunning Designs for Every Occasion!
        </p>
      </div>
      ...
      <div class="w-100">
        ...
        <div class="mb-5">
            ...
            <select class="form-select form-select-sm">
              <option value="within last day">Toppers</option>
              <option value="within last week">Candles</option>
              <option value="within last month">Color Smoke</option>
              <option value="within last 3 months">Foil Baloons</option>
          ...
          <div class="border-bottom pb-4 mb-4">
            ...
            <div class="d-grid gap-2">
              ...
              <div class="form-check">
                ...
                <label class="form-check-label" for="adidasCheckbox">Gold</label>
              </div>
              <!-- End Checkboxes -->
              ...
              <div class="form-check">
                ...
                <label class="form-check-label" for="newBalanceCheckbox">Silver</label>
              </div>
              <!-- End Checkboxes -->
              ...
              <div class="form-check">
                ...
                <label class="form-check-label" for="nikeCheckbox">Other</label>
              </div>
              <!-- End Checkboxes -->
...
<div class="col-9">
    ...
    <div class="col-lg-4">
        <a href="product.php">
            <div class="card">
                <div class="card-image">
                    <img src="images/c2.jpg" alt="Vanilla Car Design">
                </div>
                <div class="card-text">
                    <p class="card-meal-type">Decoration</p>
                    <h2 class="card-title">Birthday Cake Topper</h2>
                </div>
                <div class="card-price">Rs. 350.00</div>
            </div>
        </a>
    ...
    <div class="col-lg-4">
        <a href="product.php">
            <div class="card">
                <div class="card-image">
                    <img src="images/c3.jpg" alt="Engagement Cake">
                </div>
                <div class="card-text">
                <p class="card-meal-type">Decoration</p>
                <h2 class="card-title">Birthday Cake Topper</h2>
    ...
    <div class="col-lg-4">
        <a href="product.php">
            <div class="card">
                <div class="card-image">
                    <img src="images/c4.jpg" alt="Engagement Cake">
                </div>
                <div class="card-text">
                <p class="card-meal-type">Decoration</p>
                <h2 class="card-title">Birthday Cake Topper</h2>
