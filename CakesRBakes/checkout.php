                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <ul class="checkout__total__products">
                                    <li><samp>01.</samp> Chocolate cake<span>Rs. 1990.00</span></li>
                                    <li><samp>02.</samp> Fruit Gateau <span>Rs. 2000.00</span></li>
                                    <!-- <li><samp>03.</samp> Sweet autumn <span>$ 170.0</span></li>
                                    <li><samp>04.</samp> Cluten free mini dozen <span>$ 110.0</span></li> -->
                                </ul>
                                <ul class="checkout__total__all">
                                    <li>Subtotal <span>Rs. 3990.00</span></li>
                                    <li>Total <span>Rs. 3990.00</span></li>
                                </ul>
                                <div class="checkout__input__checkbox">
                                    <label for="acc-or">
                                        Create an account?
